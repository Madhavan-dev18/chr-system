...
export default async function DoctorPatientsDashboard() {
      ...
      >
        ...
        <div className="w-full text-left text-sm text-[#5A5A7A]">
          ...
          <div className="grid grid-cols-5 gap-4 px-4 py-4 items-center transition-colors hover:bg-[#EEF0F5]/50 rounded-xl mt-2 cursor-pointer">
            ...
            <div>
              <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-[#F39C12]/10 text-[#F39C12]">
                Needs Review
              </span>
            </div>
            <div>
              <Link href="/doctor/patients/MRN-202606-0001" className="text-[#4A90D9] font-semibold hover:underline">
                View Chart &rarr;
              </Link>
            </div>
          </div>
